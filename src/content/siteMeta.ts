...
export const SITE_META: Record<string, SiteMeta> = {
  erichathaway: {
    ...
    title: "Eric Hathaway. AI Operating Architect · Chief AI Officer @ Level9 OS",
    description: "AI Operating Architect. Chief AI Officer @ Level9 OS. 20+ years of operations leadership across six continents, building commercial AI for the half of every company that isn't customer-facing.",
    ogEyebrow: "Eric Hathaway",
    ogHeadline: "The architect behind the builds.",
    ogTagline: "AI Operating Architect · Chief AI Officer @ Level9 OS",
